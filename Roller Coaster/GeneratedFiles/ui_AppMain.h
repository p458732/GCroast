...
"}"));
        ...
        tautautau->setObjectName(QStringLiteral("tautautau"));
...
" }"));
    ...
    void retranslateUi(QMainWindow *AppMainClass)
    {
        ...
        deletecar->setText(QApplication::translate("AppMainClass", "Delete Car", Q_NULLPTR));
        ...
        addcar->setText(QApplication::translate("AppMainClass", "Add Car", Q_NULLPTR));
